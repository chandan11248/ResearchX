...
import { validateResearchXPluginManifest } from "../src/research/plugin-manifest.js";
...
test("plugin manifest validation accepts entity extractors and experiment runners only inside research jobs", () => {
	const valid = validateResearchXPluginManifest({
		manifest_version: 1,
		name: "bionemo-lite",
	...
	const invalid = validateResearchXPluginManifest({
		manifest_version: 1,
		name: "../bad",

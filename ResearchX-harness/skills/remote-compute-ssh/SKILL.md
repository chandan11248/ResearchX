...
description: Run ResearchX research jobs on SSH, Slurm, or lab hosts. Use when a task needs remote host setup, job submission, log harvest, artifact sync, or GPU/cluster execution outside Modal.
---
...
4. Harvest stdout/stderr, job id, exit status, produced artifacts, and checksums into the ResearchX workspace.

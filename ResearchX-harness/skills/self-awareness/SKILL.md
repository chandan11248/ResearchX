---
name: self-awareness
description: Inspect the active ResearchX workbench session, artifacts, execution log, settings, and provenance. Use when the task asks what happened in this session, which files were written, what tools ran, or what remains unverified.
---

# Self Awareness

Use this skill to answer questions about the active ResearchX session.
...
This skill is for ResearchX introspection, not for querying the local reference app.

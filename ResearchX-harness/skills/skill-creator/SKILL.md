---
name: skill-creator
description: Create or revise ResearchX skills. Use when a research workflow needs a reusable on-demand capability, skill metadata, trigger wording, references, scripts, or skill validation.
---

# Skill Creator

Use this skill to create ResearchX-owned skills.
...
4. Avoid copying third-party product instructions verbatim; adapt observed structure into ResearchX-owned behavior.

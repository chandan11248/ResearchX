...
2. Verify the available execution route from ResearchX Settings, notebook runtimes, managed endpoints, Modal, SSH, or local installs before claiming the model can run.
...
4. Save structures, confidence outputs, logs, and rendered previews as ResearchX artifacts.

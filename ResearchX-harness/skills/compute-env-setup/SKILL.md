...
description: Set up a reproducible ResearchX compute environment for research jobs. Use when a task needs Python/R packages, GPU libraries, containers, Modal, SSH, caches, or managed model runtime setup.
---
...
3. Verify credentials and CLIs through ResearchX Settings or environment status without printing secret values.

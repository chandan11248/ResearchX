export function buildProjectAgentsTemplate(): string {
	return `# ResearchX Project Guide

This file is read automatically at startup. It is the durable project memory for ResearchX.
...
Use \`/log\` to write one durable note per meaningful ResearchX session.

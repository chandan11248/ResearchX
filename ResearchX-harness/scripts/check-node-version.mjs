...
function getUnsupportedNodeVersionLines(version = process.versions.node) {
	...
	const parsed = parseNodeVersion(version);
	return [
		`researchx supports Node.js ${MIN_NODE_VERSION} through ${MAX_NODE_MAJOR}.x (detected ${version}).`,
...
if (!isSupportedNodeVersion()) {
	...
	// bin/researchx.js enforces the supported range at runtime with the same message.

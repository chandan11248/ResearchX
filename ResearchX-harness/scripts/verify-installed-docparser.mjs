...
export const VERIFICATION_PHRASE = "ResearchX installed docparser verification phrase";
...
export function resolveInstalledDocparserPaths(packageRoot = defaultPackageRoot) {
	...
	const runtimeRoot = resolve(resolvedPackageRoot, ".researchx", "npm");
...
export async function verifyInstalledDocparser(options = {}) {
	...
	const root = await mkdtemp(resolve(tmpdir(), "researchx-installed-docparser-"));

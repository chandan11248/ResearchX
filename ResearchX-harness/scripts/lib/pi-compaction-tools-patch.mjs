...
export const PI_COMPACTION_TOOLS_PATCH_MARKERS = Object.freeze({
	request: "ResearchX Pi 0.84.2 forward patch: disable tools during summarization",
	historyResponse: "ResearchX Pi 0.84.2 forward patch: reject compaction tool calls",
	prefixResponse: "ResearchX Pi 0.84.2 forward patch: reject turn-prefix tool calls",
	branchResponse: "ResearchX Pi 0.84.2 forward patch: reject branch-summary tool calls",
	summaryFailure: "ResearchX Pi 0.84.2 forward patch: reject truncated summaries",
	summaryFailureTypes: "ResearchX Pi 0.84.2 forward patch: type truncated-summary guard",
	contextBudgets: "ResearchX Pi 0.84.2 hotfix: bound compaction budgets to model context",
	contextCallers: "ResearchX Pi 0.84.2 hotfix: pass model context into compaction preparation",
	contextBudgetTypes: "ResearchX Pi 0.84.2 hotfix: type model-bounded compaction budgets",
	branchRequestBudget: "ResearchX Pi 0.84.2 hotfix: bound branch summary request to model limits",
	branchHistoryCapacity: "ResearchX Pi 0.84.2 hotfix: fail closed when non-empty branch history cannot fit",
	summaryIntegrity: "ResearchX Pi 0.84.2 hotfix: reject unusable summary checkpoints",
	branchIntegrity: "ResearchX Pi 0.84.2 hotfix: reject unusable branch checkpoints",
	summaryIntegrityTypes: "ResearchX Pi 0.84.2 hotfix: type summary integrity guard",
});

...
export const PI_EDIT_LINE_ENDINGS_PATCH_MARKERS = Object.freeze({
	editDiff: "ResearchX Pi 0.84.2 edit patch: preserve original line endings",
	editTypes: "ResearchX Pi 0.84.2 edit patch: typed preserved line endings",
	edit: "ResearchX Pi 0.84.2 edit patch: write preserved mixed line endings",
});

...
export const PI_LLAMA_USAGE_PATCH_MARKER =
	"ResearchX Pi 0.84.2 llama.cpp cached usage migration";
...
function repairResearchXLlamaUsage(model) {
...
const STORED_MODELS_PATCHED = `            if (context.stored) {
                const repairedStoredModels = context.stored.models.map(repairResearchXLlamaUsage);

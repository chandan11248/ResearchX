...
```bash
researchx autoresearch "Optimize prompt engineering strategies for math reasoning on GSM8K"
```

Autoresearch runs in the active ResearchX session after you confirm the benchmark, metric, environment, files in scope, and iteration limit.

...
Use `researchx paper` when you already have a DOI, arXiv ID, OpenAlex ID, PMID, PMCID, or title and need to find the best legal access route.

## Usage

```bash
researchx paper 10.7717/peerj.4375
researchx paper pmid:29456894
researchx paper 2309.08600 --fetch-full-text
researchx paper "The state of OA" --json
```

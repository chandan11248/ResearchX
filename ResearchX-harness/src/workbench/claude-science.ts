	...
	return [
		{
			...
			description: "Internal read-only blueprint used to compare schemas, tool coverage, skills, agents, and seed workflow shapes while ResearchX owns its runtime.",
			status: "read-only",

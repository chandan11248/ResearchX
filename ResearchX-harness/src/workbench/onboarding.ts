...
const ONBOARDING_SCHEMA = "researchx.workbenchOnboarding.v1" as const;
const RESEARCHX_BIO_TOOLS_NAME = "ResearchX Bio Tools";
...
export function onboardingSettingsRecords(
	...
	if (permissions.includes("science-databases") || permissions.includes("connectors")) {
		records.push({
			collection: "permissionGrants",
			record: {
				id: "onboarding-researchx-bio-tools",
				name: RESEARCHX_BIO_TOOLS_NAME,

...
export type WorkbenchOAuthPendingStore = {
	schema: "researchx.workbenchOAuthPending.v1";
...
const TOKEN_SCHEMA = "researchx.workbenchOAuthTokens.v1" as const;
const PENDING_SCHEMA = "researchx.workbenchOAuthPending.v1" as const;

...
const MODEL_CREDENTIAL_SECTIONS: Record<string, { section: string; source: string; tags: string[] }> = {
	...
	opencode: { section: "Model providers", source: "ResearchX model login", tags: ["model", "gateway"] },
	"opencode-go": { section: "Model providers", source: "ResearchX model login", tags: ["model", "gateway"] },
	openrouter: { section: "Model providers", source: "ResearchX model login", tags: ["model", "gateway"] },
};
...
const ADDITIONAL_CREDENTIAL_PROVIDERS: WorkbenchCredentialProvider[] = [
	...
	{ id: "kaggle", name: "Kaggle", envVar: "KAGGLE_KEY", section: "Cloud providers", source: "Environment", tags: ["compute", "cloud"] },
	{ id: "nvidia", name: "NVIDIA API", envVar: "NVIDIA_API_KEY", section: "Cloud providers", source: "Environment", tags: ["biology", "inference"] },
	{ id: "exa", name: "Exa Search", envVar: "EXA_API_KEY", section: "Evidence and models", source: "ResearchX search settings", tags: ["search", "papers"] },
	{ id: "perplexity", name: "Perplexity Search", envVar: "PERPLEXITY_API_KEY", section: "Evidence and models", source: "ResearchX search settings", tags: ["search", "papers"] },
];
...
const modelCredentialProviders = MODEL_API_KEY_PROVIDERS.flatMap((provider): WorkbenchCredentialProvider[] => {
	...
	return [{
		...
		source: overrides?.source ?? "ResearchX model login",

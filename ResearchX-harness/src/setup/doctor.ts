...
export type ResearchXStatusSnapshot = {
	model?: string;
	modelValid: boolean;
...
export async function collectStatusSnapshot(options: DoctorOptions): Promise<ResearchXStatusSnapshot> {
...
export async function runDoctor(options: DoctorOptions): Promise<void> {
	...
	console.log("setup hint: researchx setup");
}

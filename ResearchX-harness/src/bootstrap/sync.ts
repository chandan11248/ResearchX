...
export function syncBundledAssets(appRoot: string, agentDir: string): BootstrapSyncResult {
	...
	syncManagedFiles(resolve(appRoot, ".researchx", "themes"), resolve(agentDir, "themes"), "themes", state, result);
	syncManagedFiles(resolve(appRoot, ".researchx", "agents"), resolve(agentDir, "agents"), "agents", state, result);
	syncManagedFiles(resolve(appRoot, ".researchx", "config"), agentDir, "config", state, result);
